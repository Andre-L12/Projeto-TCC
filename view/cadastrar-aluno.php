                ...
                <div class="form-container">
                    ...
                    <form action="../control/cadastrarAluno.php" method="POST" name="formCadastroAluno" enctype="multipart/form-data">
                        ...
                        <div class="form-campo">
                            ...
                            <input type="email" name="email" id="email" placeholder="ex.: aluno10@gmail.com" class="form-input" value="<?php echo $email ?>">
                        </div>

                        <!-- Campo CELULAR -->
                        <div class="form-campo">
                            <label for="celular" class="form-subtitulo">Celular:</label>
                            <input type="tel" name="celular" id="celular" onkeyup="handlePhone(event)" placeholder="ex.: (27) 99955-1899" class="form-input" value="<?php echo $celular ?>">
                        </div>
